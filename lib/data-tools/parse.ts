...
export type TolerantParseStrategy = "strict" | "json5" | "repaired" | "failed";

export type TolerantParseResult = {
  value: unknown | null;
  strictJsonValid: boolean;
  parseStrategy: TolerantParseStrategy;
  warnings: string[];
  errors: string[];
};
...
export function parseTolerantJsonText(input: string): TolerantParseResult {
