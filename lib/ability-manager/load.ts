  ...
  for (const [absolutePath, indexed] of [...fileMap.entries()].sort((left, right) => left[0].localeCompare(right[0]))) {
    ...
    try {
      ...
      abilities.push({
        ...
        rarity: properties.rarity === undefined || properties.rarity === null ? "" : String(properties.rarity),
        minimumModLevel: properties.minimumModLevel === undefined || properties.minimumModLevel === null ? "" : String(properties.minimumModLevel),
        primaryModSlot: properties.primaryModSlot === undefined || properties.primaryModSlot === null ? "" : String(properties.primaryModSlot).trim(),
        secondaryModSlot: properties.secondaryModSlot === undefined || properties.secondaryModSlot === null ? "" : String(properties.secondaryModSlot).trim(),
