...
const DATA_SECTIONS = [
  ...
  {
    href: "/data/generated-areas",
    title: "Generated Areas",
    description: "Review procedural area staging, edit generated zone stage placements, approve promotion, promote into core generated data files, or reject and delete generated artifacts.",
    keys: ["generatedAreas", "zones", "mobs", "comms", "missions"],
  },
  {
    href: "/data/ai",
    title: "AI JSON",
    description: "Browse AI profile JSON generated by the game and see scripts, ranges, ability groups, behavior blocks, and mob references.",
    keys: ["ai", "mobs"],
  },
  {
